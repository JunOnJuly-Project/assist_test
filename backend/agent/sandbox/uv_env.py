...
class UvSandbox:
    ...
    async def run_code(self, source_code: str) -> str:
        """
        주어진 Python 소스 코드를 파일로 저장한 뒤 격리된 프로세스로 실행합니다.
        ...
        try:
            ...
            try:
                ...
                process.kill()
                await process.communicate() # 좀비 프로세스 방어
